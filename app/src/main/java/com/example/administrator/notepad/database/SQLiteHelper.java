package com.example.administrator.notepad.database;
...
import com.example.administrator.notepad.utils.DBUtils;
...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        db.execSQL("create table "+DBUtils.DATANASE_TABLE+"("+DBUtils.NOTEPAD_ID+" integer primary key autoincrement,"+DBUtils.NOTEPAD_CONTENT+" text,"+DBUtils.NOTEPAD_TIME+" text)");
    }
    @Override
   ...
   //添加数据
    public boolean insertData(String userContent,String userTime){
        ...
        return
                sqLiteDatabase.insert(DBUtils.DATANASE_TABLE,null,contentValues)>0;
    }
    //删除数据
    public boolean deleteData(String id){
        ...
        return
                sqLiteDatabase.delete(DBUtils.DATANASE_TABLE,sql,contentValuesArray)>0;
    }
    //修改数据
    public boolean updateData(String id,String content,String userYear){
        ...
        return
                sqLiteDatabase.update(DBUtils.DATANASE_TABLE,contentValues,sql,strings)>0;
    }
    //查询数据
    public List<NotepadBean> query(){
        List<NotepadBean> list=new ArrayList<NotepadBean>();
        Cursor cursor=sqLiteDatabase.query(DBUtils.DATANASE_TABLE,null,null,null,
